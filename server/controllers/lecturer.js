...
exports.createLecturer = (req, res, next) => {
  ...
  database
    .query(
      "INSERT INTO lecturer (lecturer_id, username, password, email, address, full_name, phone_number, image, gender, date_of_birth, specialization, department_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
      [
        lecturer_id,
        username,
        password,
...
exports.updateLecturer = (req, res, next) => {
  ...
  database
    .query(
      "UPDATE lecturer SET lecturer_id = ?, username = ?, password = ?, email = ?, address = ?, full_name = ?, phone_number = ?, image = ?, gender = ?, date_of_birth = ?, specialization = ?, department_id = ? WHERE lecturer_id = ?",
      [
        lecturer_id,
        username,
        password,
