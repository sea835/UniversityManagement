...
function CourseContent() {
  ...
  return (
    <section className="flex flex-col grow px-5 py-8 w-full bg-white rounded-3xl max-md:mt-3.5 max-md:max-w-full">
      <h2 className="self-start text-2xl font-semibold tracking-wide text-black max-md:max-w-full">
      ...
      <div className="flex flex-col items-start py-9 pr-3 pl-10 mt-7 w-full rounded-xl bg-zinc-100 max-md:pl-5 max-md:max-w-full">
        {view === "course" ? (
      ...
      <div className="flex overflow-hidden flex-col justify-center px-8 py-6 bg-white rounded-xl min-h-[149px] max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col w-full max-md:max-w-full">
          ...
          <div className="flex flex-col mt-5 max-w-full w-[780px]">
            ...
            <div className="text-xs text-stone-500 text-opacity-80">95/100</div>
          </div>
...
function ChapterSection({ name, score, content }) {
  return (
    <div className="flex overflow-hidden flex-wrap mt-7 bg-white rounded-xl min-h-[177px]">
      ...
      <div className="flex flex-col self-start py-6 min-w-[240px] w-[800px] max-md:max-w-full">
